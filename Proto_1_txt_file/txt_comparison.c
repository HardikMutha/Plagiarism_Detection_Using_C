...
void check_filetypes_and_update_filenames(char *filename, int fileNumber)
{
    ...
    if (ft == 2) // Check if the file is of the type .pdf
    {
        /*
            ...
            The text file is stored in the folder Proto_1_txt_file/Tests/PdfTempx.txt where x is the file number.
...
void writeToHTML(int numberFiles)
{
    ...
    FILE *fptr = fopen("./Proto_1_txt_file/index.html", "w");
...
int main(int argc, char *argv[])
{
    ...
    system("mkdir ./Proto_1_txt_file/Output_Graphs -p"); // Create a directory to store the output graphs
    ...
    printf("index.html is generated in main folder");
    return 0;
}
