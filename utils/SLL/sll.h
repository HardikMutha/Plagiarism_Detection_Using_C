...
/*
    The TokenType enum is used to define the type of token that is being stored in the list
    for easier identification and processing instead of using strings.
*/
